...
## Current Phase: 2+3 (Contracts + Foundation) — IN PROGRESS

Next action: Set up PGlite client, Zustand store skeleton, ESLint, then tag golden commit
...
- [ ] Set up linting + formatting (ESLint + Prettier) — deferred, not blocking
- [ ] Tag golden commit (v0.0.0-skeleton)
